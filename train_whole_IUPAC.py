...
from model.multi_modality import Net
from tokenizer import text_tokenizer_result
import os
...
tokenizer = AutoTokenizer.from_pretrained("model/local_cache/distilroberta")
